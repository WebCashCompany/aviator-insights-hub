  ...
  return (
    <>
      <style>{`
        ...
        /* ── Success state ── */
        .lp-success { display:flex; flex-direction:column; align-items:center; gap:20px; text-align:center; }
        .lp-success-icon {
        ...
        .lp-success-title { font-family:'Outfit',sans-serif; font-size:17px; font-weight:600; color:#fff; }
        ...
        .lp-btn-outline {
          ...
          border-radius:12px; color:rgba(226,232,240,.85); font-family:'Outfit',sans-serif;
          font-size:14px; font-weight:600; letter-spacing:.3px; padding:14px;
        ...
        .lp-back { font-family:'Inter',sans-serif; font-size:13px; color:rgba(99,179,237,.8); text-decoration:none; text-align:center; display:block; margin-top:16px; transition:color .2s; }
        .lp-back:hover { color:#90cdf4; }
      ...
      <div className="lp-scene">
        <div className={`lp-card${visible ? ' in' : ''}`}>
          ...
          <div className="lp-logo">
            ...
            <div className="lp-tagline">Recuperação de senha</div>
          </div>
          ...
          {sent ? (
            <div className="lp-success">
              ...
              <div className="lp-success-title">Email enviado!</div>
              <div className="lp-success-msg">
                Enviamos um link de recuperação para
              </div>
              <div className="lp-success-email">{email}</div>
              <div className="lp-success-msg" style={{ marginTop: '-8px' }}>
                Verifique sua caixa de entrada e a pasta de spam.
              </div>
              <Link to="/login" className="lp-btn-outline" style={{ marginTop: '4px' }}>
                Voltar ao login
              </Link>
            </div>
          ) : (
